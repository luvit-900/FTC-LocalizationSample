...
@Autonomous(name="spinDriveTest", group="Opmode")
public class spinDriveTest extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        DataLogger = new SBSDataLogger("ST");
        ...
        //initial position
        arde.addWaypoint(new Waypoint(new Coordinate(Coordinate.CoordinateType.TerabyteF, 0,  0,   0.0), 0, Waypoint.TimeType.Init, 0));
        //first waypoint
        arde.addWaypoint(new Waypoint(new Coordinate(Coordinate.CoordinateType.TerabyteF, 0, 48,   -3.14159265), 5, Waypoint.TimeType.FromLastWaypoint, 1));
        //Wait a few seconds to make sure we don't overshoot
        arde.addWaypoint(new Waypoint(new Coordinate(Coordinate.CoordinateType.TerabyteF, 0, 48,   -3.14159265), 2, Waypoint.TimeType.FromLastWaypoint, 2));
        //return to where we started
        arde.addWaypoint(new Waypoint(new Coordinate(Coordinate.CoordinateType.TerabyteF, 0, 0,   0.0), 5, Waypoint.TimeType.FromLastWaypoint, 3));
